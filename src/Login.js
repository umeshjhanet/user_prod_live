...
//   //       const passwordChangedFlag = localStorage.getItem(`passwordChanged_${data.user_id}`);
  
//   //       if (data.isChangePasswordRequired && !passwordChangedFlag) {
//   //         setIsModalOpen(true);
//   //         setUserId(data.user_id);
//   //       } else {
//   //         navigateToDestination(data);
...
//   //   // Set flag in localStorage to prevent showing the modal again for this user
//   //   localStorage.setItem(`passwordChanged_${data.user_id}`, true);
