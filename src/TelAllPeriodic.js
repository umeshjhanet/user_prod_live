...
//                       <td>{lastColumnTotal.toFixed(2).toLocaleString()}</td>
//                     </tr>
//                   </tbody>
//                 </table>
//               )}
...
//                       <td>{elem.rowSum ? elem.rowSum.toFixed(2).toLocaleString() : 0}</td>
//                       <td></td>
//                     </tr>
//                   ))}
//                 </tbody>
...
//                                 <td>{totalRate.toFixed(2).toLocaleString()}</td>
//                               </tr>
//                             );
//                           })}
...
//                             </td>
//                             <td>
//                               <strong>{columnSums.Inventory.toFixed(2).toLocaleString()}</strong>
//                             </td>
//                             <td>
//                               <strong>{columnSums.Counting.toFixed(2).toLocaleString()}</strong>
//                             </td>
//                             <td>
//                               <strong>{columnSums.DocPreparation.toFixed(2).toLocaleString()}</strong>
//                             </td>
//                             <td>
//                               <strong>{columnSums.Guard.toFixed(2).toLocaleString()}</strong>
//                             </td>
//                             <td>
//                               <strong>{columnSums.Scanned.toFixed(2).toLocaleString()}</strong>
//                             </td>
//                             <td>
//                               <strong>{columnSums.QC.toFixed(2).toLocaleString()}</strong>
//                             </td>
//                             <td>
//                               <strong>{columnSums.Flagging.toFixed(2).toLocaleString()}</strong>
//                             </td>
//                             <td>
//                               <strong>{columnSums.Indexing.toFixed(2).toLocaleString()}</strong>
//                             </td>
//                             <td>
//                               <strong>{columnSums.CBSL_QA.toFixed(2).toLocaleString()}</strong>
//                             </td>
//                             <td>
//                               <strong>{columnSums.Client_QC.toFixed(2).toLocaleString()}</strong>
//                             </td>

//                             <td>
//                               {/* Assuming `Expense Rate` sum calculation logic needs to be added if required */}
//                               <strong>{columnSums.totalExpenseRate.toFixed(2).toLocaleString()}</strong>
//                             </td>
//                             <td></td>
//                           </tr>
//                         </tbody>
...
//                             </td>
//                             <td>
//                               <strong>{columnSumsUser.Inventory.toFixed(2).toLocaleString()}</strong>
//                             </td>
//                             <td>
//                               <strong>{columnSumsUser.Counting.toFixed(2).toLocaleString()}</strong>
//                             </td>
//                             <td>
//                               <strong>{columnSumsUser.DocPreparation.toFixed(2).toLocaleString()}</strong>
//                             </td>
//                             <td>
//                               <strong>{columnSumsUser.Guard.toFixed(2).toLocaleString()}</strong>
//                             </td>
//                             <td>
//                               <strong>{columnSumsUser.Scanned.toFixed(2).toLocaleString()}</strong>
//                             </td>
//                             <td>
//                               <strong>{columnSumsUser.QC.toFixed(2).toLocaleString()}</strong>
//                             </td>
//                             <td>
//                               <strong>{columnSumsUser.Flagging.toFixed(2).toLocaleString()}</strong>
//                             </td>
//                             <td>
//                               <strong>{columnSumsUser.Indexing.toFixed(2).toLocaleString()}</strong>
//                             </td>
//                             <td>
//                               <strong>{columnSumsUser.CBSL_QA.toFixed(2).toLocaleString()}</strong>
//                             </td>
//                             <td>
//                               <strong>{columnSumsUser.Client_QC.toFixed(2).toLocaleString()}</strong>
//                             </td>
//                             <td>
//                               <strong>{columnSumsUser.totalExpenseRate.toFixed(2).toLocaleString()}</strong>
//                             </td>
//                             <td></td>
//                           </tr>
//                         </tbody>
...
const TelAllPeriodic = ({ multipliedData, startDate, endDate, userData }) => {
  ...
  //         CBSL : item.IsApprovedCBSL || 0,
  //         PM: item.IsApprovedPM || 0,
  //         PO: item.IsApprovedPO || 0,
  //         HR: item.IsApprovedHR || 0
  //       };
  //     } else {
    ...
    data.forEach(item => {
      if (item.user_type) {
        ...
        if (!initialStatus[role]) {
          initialStatus[role] = {
            'CBSL Site User': 0,  // Default value for CBSL Site User
            PM: 0,
            PO: 0,
            HR: 0
          };
